...
if(!isset($_SESSION['user'])){
    ...
    // header('Location: https://herosacai.000webhostapp.com/admin.php');
        ...
        <div class="container-fluid">
            ...
            <span class="navbar-brand">
                ...
                <div class="d-flex align-items-center justify-content-start">
                    <span class="logo" style="margin-right: 12px;">
                ...
                <div class="d-flex flex-column flex-shrink-0 p-0 bg-primary" style="width: 100%; height: calc(100vh - 106px);">
                    ...
                    <div class="accordion accordion-flush mt-3" id="accordionFlushExample">
                        ...
                        <div class="accordion-item mb-1">
                            ...
                            <h2 class="accordion-header" id="bairros">

                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-bairros" aria-expanded="false" aria-controls="flush-bairros">
                            ...
                            <div id="flush-bairros" class="accordion-collapse collapse" aria-labelledby="flush-bairros" data-bs-parent="#accordionFlushExample">

                            <div class="accordion-body p-0">

                                    <ul class="list-group">

                                        <li class="list-group-item li-add-bairros menu">Adicionar novo bairro</li>

                                        <li class="list-group-item li-excluir-bairros menu">Excluir bairros</li>
                ...
                <div class="col-md-3 p-0">
                    ...
                    <div class="d-flex flex-column flex-shrink-0 p-0 bg-primary" style="width: 100%; height: calc(100vh - 106px);">
                        ...
                        <div class="accordion accordion-flush mt-3" id="accordionFlushExample2">
                            ...
                            <h2 class="accordion-header" id="bairros2">

                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-bairros2" aria-expanded="false" aria-controls="flush-bairros2">
                            ...
                            <div id="flush-bairros2" class="accordion-collapse collapse" aria-labelledby="flush-bairros2" data-bs-parent="#accordionFlushExample2">

                            <div class="accordion-body p-0">

                                    <ul class="list-group">

                                        <li class="list-group-item li-add-bairros menu"
                                        data-bs-dismiss="offcanvas" aria-label="Close">Adicionar novo bairro</li>

                                        <li class="list-group-item li-excluir-bairros menu"
                                        data-bs-dismiss="offcanvas" aria-label="Close">Excluir bairros</li>
