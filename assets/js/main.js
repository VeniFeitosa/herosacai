import {htmlExcluirBairro, htmlNovoBairro, htmlExcluirAdiPag, htmlDisponiAdiPag, htmlNovoAdiPag, htmlExcluirAdi, htmlDisponiAdi, htmlNovoAdi, htmlExcluirCreme, htmlDisponiCreme, htmlNovoCreme, htmlExcluirAcai, htmlNovoAcai, htmlExcluirTipo, htmlDisponiTipo, htmlNovoTipo, semana} from './modules.js'
...
// const host = "https://herosacai.000webhostapp.com"
...
$('.logar').submit(e =>{
    ...
    fetch(`${host}/assets/php/logar.php`, {
...
$('.sair').click(e =>{
    ...
    fetch(`${host}/assets/php/sair.php`, {

    }).then(e => {


        window.location.href = `${host}/admin.php`
...
$('.li-add-tipo').click(e =>{
    ...
    $('.formAddTipo').submit(e =>{
        ...
        fetch(`${host}/assets/php/add/add_tipo.php`, {
...
$('.li-editar-tipo').click(e =>{
    ...
    fetch(`${host}/assets/php/edit/edit_tipo.php`).then(res => res.json()).then(response =>{

        $('.loading').html('')

        response.tipos.forEach(element =>{

            gerarEditarTipo(element.id, element.tipo, parseInt(element.falta))
    ...
    $('.salv-editar-tipo').click(e =>{
        ...
        fetch(`${host}/assets/php/edit/save_tipo.php`, {
    ...
    fetch(`${host}/assets/php/edit/edit_tipo.php`).then(res => res.json()).then(response =>{
        ...
        excluirTipoImg.forEach(e =>{
            ...
            e.addEventListener('click', element =>{
                ...
                fetch(`${host}/assets/php/del/del_tipo.php?id=${id}`)
...
$('.li-add-acai').click(e =>{
    ...
    $('#cadPrecoAcai')[0].addEventListener('input', e =>{

        $('#cadPrecoAcai').maskMoney('mask')
    ...
    $('.formAddAcai').submit(e =>{
        ...
        fetch(`${host}/assets/php/add/add_acai.php`, {
...
$('.li-excluir-acai').click(e =>{
    ...
    fetch(`${host}/assets/php/edit/edit_acai.php`).then(res => res.json()).then(response =>{
        $('.loading').html('')
        ...
        excluirAcaiImg.forEach(e =>{
            ...
            e.addEventListener('click', element =>{
                ...
                fetch(`${host}/assets/php/del/del_acai.php?id=${id}`)
...
$('.li-add-creme').click(e =>{
    ...
    $('.formAddCreme').submit(e =>{
        ...
        fetch(`${host}/assets/php/add/add_creme.php`, {
...
$('.li-editar-creme').click(e =>{
    ...
    fetch(`${host}/assets/php/edit/edit_creme.php`).then(res => res.json()).then(response =>{
        $('.loading').html('')
    ...
    $('.salv-editar-creme').click(e =>{
        ...
        fetch(`${host}/assets/php/edit/save_creme.php`, {
    ...
    fetch(`${host}/assets/php/edit/edit_creme.php`).then(res => res.json()).then(response =>{
        ...
        excluirCremeImg.forEach(e =>{
            ...
            e.addEventListener('click', element =>{
                ...
                fetch(`${host}/assets/php/del/del_creme.php?id=${id}`)
...
$('.li-add-adi').click(e =>{
    ...
    $('.formAddAdi').submit(e =>{
        ...
        fetch(`${host}/assets/php/add/add_adi.php`, {
...
$('.li-editar-adi').click(e =>{
    ...
    fetch(`${host}/assets/php/edit/edit_adi.php`).then(res => res.json()).then(response =>{
        $('.loading').html('')
    ...
    $('.salv-editar-adi').click(e =>{
        ...
        fetch(`${host}/assets/php/edit/save_adi.php`, {
    ...
    fetch(`${host}/assets/php/edit/edit_adi.php`).then(res => res.json()).then(response =>{
        ...
        excluirAdiImg.forEach(e =>{
            ...
            e.addEventListener('click', element =>{
                ...
                fetch(`${host}/assets/php/del/del_adi.php?id=${id}`)
...
$('.li-add-adiPag').click(e =>{
    ...
    $('#cadPrecoAdiPag')[0].addEventListener('input', e =>{

        $('#cadPrecoAdiPag').maskMoney('mask')
    ...
    $('.formAddAdiPag').submit(e =>{
        ...
        fetch(`${host}/assets/php/add/add_adiPag.php`, {
...
$('.li-editar-adiPag').click(e =>{
    ...
    fetch(`${host}/assets/php/edit/edit_adiPag.php`).then(res => res.json()).then(response =>{
        $('.loading').html('')
    ...
    $('.salv-editar-adiPag').click(e =>{
        ...
        fetch(`${host}/assets/php/edit/save_adiPag.php`, {
    ...
    fetch(`${host}/assets/php/edit/edit_adiPag.php`).then(res => res.json()).then(response =>{
        ...
        excluirAdiPagImg.forEach(e =>{
            ...
            e.addEventListener('click', element =>{
                ...
                fetch(`${host}/assets/php/del/del_adiPag.php?id=${id}`)
...
$('.li-add-bairros').click(e =>{

    cardNovoBairro()

    $("#cadPrecoBairro").maskMoney({prefix:'R$ ', allowNegative: false, thousands:'.', decimal:','})
    $('#cadPrecoBairro')[0].addEventListener('input', e =>{

        $('#cadPrecoBairro').maskMoney('mask')
  
    })


    $('.formAddBairro').submit(e =>{

        e.preventDefault()

        

        const bairro = $('#cadBairro')[0].value

        const preco = BRL($('#cadPrecoBairro')[0].value).value

        let data = {bairro:bairro, preco: preco}

        fetch(`${host}/assets/php/add/add_bairro.php`, {
...
$('.li-excluir-bairros').click(e =>{
    ...
    fetch(`${host}/assets/php/edit/edit_bairro.php`).then(res => res.json()).then(response =>{
        $('.loading').html('')
        ...
        response.bairros.forEach(element =>{
            ...
            gerarExcluirBairro(element.id, element.bairro)

        })

        const excluirBairro = document.querySelectorAll('.excluir-bairro')


        excluirBairro.forEach(e =>{

            e.addEventListener('click', element =>{

                let id = element.target.dataset.index_bairro

              

                fetch(`${host}/assets/php/del/del_bairro.php?id=${id}`)

                .then(res => res.json()).then(response =>{

                    $('.excluirBairro').html('')

                    bairros.forEach(element =>{
...
proximo.addEventListener("click", (e) =>{
    ...
    fetch(`${host}/assets/php/edit/edit_adiPag.php`).then(res => res.json())
    ...
    fetch(`${host}/assets/php/edit/edit_bairro.php`).then(res => res.json()).then(response =>{
        ...
        bairros.map(e =>{
            ...
            if(bairro[bairro.length - 1] == ' '){
                bairro = bairro.substr(0, bairro.length - 1)
            }

            if(bairro == textoSelected){
                retorno = e.frete
            }
        })
        ...
        if((selectBairro.value == "")){
            ...
            frete.innerHTML = `Frete: ${BRL(retorno).format()}`

            $('.freteCarrinho').html(`Frete: ${BRL(retorno).format()}`)
...
function gerarCardsAcai(){
    ...
    fetch(`${host}/assets/php/edit/edit_acai.php`).then(res => res.json())
...
function gerarTiposAcai(){
    ...
    fetch(`${host}/assets/php/edit/edit_tipo.php`).then(res => res.json())
...
function gerarOpcoesCremes(){
    ...
    fetch(`${host}/assets/php/edit/edit_creme.php`).then(res => res.json())
...
function gerarOpcoesAdicionais(){
    ...
    fetch(`${host}/assets/php/edit/edit_adi.php`).then(res => res.json())
...
function gerarSelect(){
    ...
    fetch(`${host}/assets/php/edit/edit_bairro.php`).then(res => res.json())
...
function formaDePagamento(){
    ...
    if(pagamento == 'dinheiro'){
        ...
        if(troco == ''){
            ...
            pedidoCompleto[4] = `Dinheiro; Troco para ${troco}`
...
function horarioFuncionamento(){
    ...
    //horaCompleta >= horarioFechar || horarioAbrir > horaCompleta || semana[diaSemana].fechado
...
function gerarExcluirBairro(id, bairro){

    $('.excluirBairro').append(`<li class="list-group-item d-flex align-items-center justify-content-between" data-li_bairro_excluir="${id}">

    <span>${bairro}</span>

    <img class="excluir-bairro" data-index_bairro="${id}" src="./assets/img/trash3.svg" width="24"></img>
...
function cardNovoBairro(){

    $('.mainCol').html('')

    $('.mainCol').append(htmlNovoBairro)
...
function cadExcluirBairro(){

    $('.mainCol').html('')

    $('.mainCol').append(htmlExcluirBairro)   
